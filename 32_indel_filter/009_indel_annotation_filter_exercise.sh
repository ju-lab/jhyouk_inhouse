...
(python 02_AddNpanelToVCFindel_vaf_fast.py $1_indel_union_2.vcf.readinfo.readc.rasmy ../31_1_PanelOfNormal_SPark/mm10_b6_4_190226.4s.q0Q0.chr1.mpileup.indel.edit.gz pon) &>> $log || { c=$?;echo "Error";exit $c; }

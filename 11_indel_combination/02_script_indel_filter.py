...
def nochange_insertion_bam(input_line, bam_file, ref_fasta):
...
#output_file = file('S1-0Gy-1-all.strelka_varscan_intersection_indel.vcf','w')
...
while input_line:
    ...
    #if input_line.split('\t')[1] != '116124919':
        #input_line = input_file.readline().strip()
        #continue       
    tdup = 0
    ndup = 0

...
(python 00_vcf_combination_by_Youk.py $1 $2 2 /home/users/jhyouk/06_mm10_SNUH_radiation/14_Strelka2/$1/results/variants/somatic.snvs.vcf.gz /home/users/jhyouk/06_mm10_SNUH_radiation/09_varscan/$1..varscan.snp.somatic.vcf) &>> $log || { c=$?;echo "Error";exit $c; }
echo "done"
...
(python 05_filter2_motherinfo_breast_mothercutoff0.156.py $1_union_2.readinfo.readc.rasmy_pon.filter1.mreadc.mrasmy.vcf /home/users/team_projects/Radiation_signature/02_bam/$1.s.md.ir.br.bam $1.mpileup.100kbcov.covstat /home/users/team_projects/Radiation_signature/02_bam/$2.s.md.ir.br.bam $2.mpileup.100kbcov.covstat) &>> $log || { c=$?;echo "Error";exit $c; }
echo "done"

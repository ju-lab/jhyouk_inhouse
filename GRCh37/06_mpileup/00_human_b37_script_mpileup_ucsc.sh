...
(samtools mpileup -B -Q 20 -q 20 -f /home/users/jhyouk/99_reference/human/hg19_UCSC/ucsc.hg19.fasta /home/users/team_projects/Radiation_signature/05_bam_human_sample_GRCh37/$1.s.md.ir.br.bam -o $1.mpileup) &>> $log || { c=$?;echo "Error";exit $c; }
echo "done" >> $log
